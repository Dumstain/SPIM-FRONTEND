...
export class CocheService {
  ...
  obtenerIdCoche(cocheData: { marca: string; modelo: string; linea: string; tipo: string; }): Observable<any> {
    return this.http.post(`${this.baseUrl}/coches/buscar-coche-id`, cocheData);
  }

  registrarInfractor(infractorData: any): Observable<any> {
    return this.http.post(`${this.baseUrl}/infractores/registrar-infractor`, infractorData); // URL correcta
  }
